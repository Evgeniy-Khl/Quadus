...
TableBuff unTable = {
    ...
    .water0on = WT0ON,      // 0-120 Длительность включ.состояниe полива № 1
    .water0off = WT0OFF,    // 0-60 Длительность отвключ.состояниe полива № 1
    .water1on = WT1ON,      // 0-120 Длительность включ.состояниe полива № 2
    .water1off = WT1OFF,    // 0-60 Длительность отвключ.состояниe полива № 2
    .water2on = WT2ON,      // 0-120 Длительность включ.состояниe полива № 3
    .water2off = WT2OFF,    // 0-60 Длительность отвключ.состояниe полива № 3
