...
uint8_t numberOfDevices,    // число найденых датчиков
        ...
        lastSyncDay = 0;    // Переменная для хранения дня последней синхронизации
...
const uint8_t output_mode[13]    = {0x50, 0x65, 0xB6, 0xB8, 0xBC, 0x20, 0xB3, 0xB8, 0x78, 0x6F, 0xE3, 0x69, 0xB3};// Режим виходів
...
const uint8_t time_saved[13]     = {0xA4, 0xB2, 0x65, 0x70, 0x65, 0xB4, 0xBF, 0xB8, 0x20, 0xC0, 0x61, 0x63, 0x3F};// Час збережено.