...
#define WT1OFF    2       // 0-15 пункт. Длительность отвключ.состояниe полива № 2
#define WT2ON     30      // 0-120 мин.Длительность включ.состояниe полива № 3
#define WT2OFF    3       // 0-15 пункт. Длительность отвключ.состояниe полива № 3
#define TIMERON   7       // 0-24 
#define TIMEROFF  7       // 0-24 
