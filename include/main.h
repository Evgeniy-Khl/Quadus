...
struct TableForOneHour{
    ...
    uint8_t spT1on; 	  // 0-120 Уставка температуры T1 или 0-100 Уставка относительной влажности ON
    uint8_t spT1off; 	  // 0-120 Уставка температуры T1 или 0-100 Уставка относительной влажности OFF
    uint8_t water0on;   // 0-120 Длительность включ.состояниe полива № 1
    uint8_t water0off;  // 0-60 Длительность отключ.состояниe полива № 1
    uint8_t water1on;   // 0-120 Длительность включ.состояниe полива № 2
    uint8_t water1off;  // 0-60 Длительность отключ.состояниe полива № 2
    uint8_t water2on;   // 0-120 Длительность включ.состояниe полива № 3on
    uint8_t water2off;  // 0-60 Длительность отключ.состояниe полива № 3on
...
#define T1ON    16 	    // 0-120 Уставка температуры T1 или 0-100 Уставка относительной влажности ON
#define T1OFF   20 	    // 0-120 Уставка температуры T1 или 0-100 Уставка относительной влажности OFF
#define WT0ON   10      // 0-120 Длительность включ.состояниe полива № 1
#define WT0OFF  1       // 0-60 Длительность отвключ.состояниe полива № 1
#define WT1ON   20      // 0-120 Длительность включ.состояниe полива № 2
#define WT1OFF  2       // 0-60 Длительность отвключ.состояниe полива № 2
#define WT2ON   30      // 0-120 Длительность включ.состояниe полива № 3
#define WT2OFF  3       // 0-60 Длительность отвключ.состояниe полива № 3
#define TF      0x80    // 0-100 Заслонка текущее положение маска 0x7F; ВКЛ./ОТКЛ. маска 0x80
#define ALARM0  5 	    // 0-250 отклонение температуры T0
#define ALARM1  5 	    // 0-25 отклонение температуры T1
