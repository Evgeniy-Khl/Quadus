...
- **Web Interface (UI/UX)**:
    ...
    - `data/index.html`: Dynamic icons (вЏ° for timer modes, рџ› пёЏ for auxiliary mode).
...
- Instant loading popups ('Р—Р±РµСЂРµР¶РµРЅРЅСЏ РїР°СЂР°РјРµС‚СЂС–РІ...', 'Р—Р°РІР°РЅС‚Р°Р¶РµРЅРЅСЏ РіРѕР»РѕРІРЅРѕС—...') in `setup.html` to provide immediate visual feedback and prevent browser freeze during configuration saves.
...
- 0.1В°C precision for sensor measurements and climate control.
